...
We'd love to have you contribute your code to make the goal of "**describe an
application once**, deploy and manage it anywhere" become a reality! Here are
the guidelines we'd like all contributors to follow:
...
[dev mailing list][checkmate-hackers] so that we can better coordinate our efforts, prevent
...
* Search [GitHub](https://github.com/checkmate/chessboard/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `chessboard:master`.
